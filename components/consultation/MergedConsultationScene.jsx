...
import { AVATARS, findAvatar, calcBmi } from "@/lib/avatars";
import { AI_ASSISTANT_NAME } from "@/lib/assistant";
import ConsultationBridge, {
  IdleDoctorOrb,
  ActiveDoctorOrb,
} from "@/components/consultation/ConsultationBridge";
import ConsultationReportActions from "@/components/consultation/ConsultationReportActions";

export default function MergedConsultationScene({
  connecting,
  connected,
  assistantIsSpeaking,
  volumeLevel,
